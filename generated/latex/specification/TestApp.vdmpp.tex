...
@*)
 ...
 (*@\vdmnotcovered{(}@*)
   (*@\vdmnotcovered{for}@*) counter = 1 to len getModelsByRunway(optionFestival, optionEvent, optionRunWay) do (*@\vdmnotcovered{(}@*)
    (*@\vdmnotcovered{getModelsByRunway}@*)((*@\vdmnotcovered{optionFestival}@*), (*@\vdmnotcovered{optionEvent}@*), (*@\vdmnotcovered{optionRunWay}@*)) ((*@\vdmnotcovered{counter}@*)).printModel();
   );
 );
