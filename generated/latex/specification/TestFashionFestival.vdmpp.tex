...
@*)
  ...
  (
    ...
    dcl ev0: Event := new Event("BaixaShow", "04/05/2018", "Baixa", 12, 60,
                   "flores", <Homem>, <Primavera_Verão>);
   dcl ev1: Event := new Event("NightOut", "15/05/2018", "Porto", 21, 120,
  "News", <Unisexo>, <Primavera_Verão>);               
    -- EXECUTE testInit()
...
\hline
\hline
TestFashionFestival.vdmpp & & 100.0\% & 1 \\
\hline
\end{longtable}
