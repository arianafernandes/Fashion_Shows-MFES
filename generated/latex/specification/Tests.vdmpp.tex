...
(*@
\label{getFestivals:163}
@*)
  public  static getFestivals : () ==> seq of FashionFestival
  getFestivals() == return (*@\vdmnotcovered{festivals}@*);
  
(*@
\label{getEvents:166}
@*)
  public  static getEvents : () ==> seq of Event
  getEvents() == (*@\vdmnotcovered{return}@*) (*@\vdmnotcovered{events}@*);
  
(*@
\label{getDesigners:169}
@*)
  public  static getDesigners : () ==> seq of Designer
  getDesigners() == (*@\vdmnotcovered{return}@*) (*@\vdmnotcovered{designers}@*);
   
(*@
\label{getModels:172}
@*)
 public  static getModels : () ==> seq of Model
  getModels() == (*@\vdmnotcovered{return}@*) (*@\vdmnotcovered{models}@*);
  
(*@
\label{getUsers:175}
@*)
  public  static getUsers : () ==> seq of FashionUser
  getUsers() == return (*@\vdmnotcovered{users}@*);
...
\hline
\hline
\hyperref[getDesigners:169]{getDesigners} & 169&0.0\% & 0 \\
\hline
\hyperref[getEvents:166]{getEvents} & 166&0.0\% & 0 \\
\hline
\hyperref[getFestivals:163]{getFestivals} & 163&0.0\% & 0 \\
\hline
\hyperref[getModels:172]{getModels} & 172&0.0\% & 0 \\
\hline
\hyperref[getUsers:175]{getUsers} & 175&0.0\% & 0 \\
\hline
\hyperref[run:16]{run} & 16&100.0\% & 1 \\
\hline
\hline
Tests.vdmpp & & 97.8\% & 1 \\
\hline
