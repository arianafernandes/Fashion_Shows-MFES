...
@*)
 ...
 public  static getModels : () ==> seq of Model
  ...
  (*@\vdmnotcovered{(}@*)
   dcl u5 : FashionUser:= new FashionUser((*@\vdmnotcovered{username}@*),password,(*@\vdmnotcovered{name}@*),(*@\vdmnotcovered{age}@*));
   (*@\vdmnotcovered{appUsers}@*) := appUsers union {(*@\vdmnotcovered{u5}@*)};
   );
...
\hline
\hline
\hyperref[getAppUsers:254]{getAppUsers} & 254&100.0\% & 2 \\
\hline
\hyperref[getDesigners:248]{getDesigners} & 248&100.0\% & 1 \\
\hline
\hyperref[getEvents:245]{getEvents} & 245&100.0\% & 1 \\
\hline
\hyperref[getFestivals:242]{getFestivals} & 242&100.0\% & 10 \\
\hline
\hyperref[getModels:251]{getModels} & 251&100.0\% & 1 \\
\hline
\hyperref[getRunways:257]{getRunways} & 257&100.0\% & 1 \\
\hline
\hyperref[run:17]{run} & 17&100.0\% & 3 \\
\hline
\hyperref[setAppUser:260]{setAppUser} & 260&0.0\% & 0 \\
\hline
\hline
Tests.vdmpp & & 98.4\% & 19 \\
\hline
