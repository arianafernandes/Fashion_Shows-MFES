...
@*)
  ...
  getEvents() == return (*@\vdmnotcovered{events}@*);
 ...
 public  static getModels : () ==> seq of Model
  ...
  getUsers() == (*@\vdmnotcovered{return}@*) (*@\vdmnotcovered{users}@*);
...
\hline
\hline
\hyperref[getDesigners:137]{getDesigners} & 137&0.0\% & 0 \\
\hline
\hyperref[getEvents:134]{getEvents} & 134&0.0\% & 0 \\
\hline
\hyperref[getFestivals:131]{getFestivals} & 131&0.0\% & 0 \\
\hline
\hyperref[getModels:140]{getModels} & 140&0.0\% & 0 \\
\hline
\hyperref[getUsers:143]{getUsers} & 143&0.0\% & 0 \\
\hline
\hyperref[run:12]{run} & 12&100.0\% & 1 \\
\hline
\hline
Tests.vdmpp & & 97.5\% & 1 \\
\hline
